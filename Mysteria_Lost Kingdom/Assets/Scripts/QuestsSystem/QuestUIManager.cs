...
//            statusText.text = $"{CompletedStepsCount(quest)}/{quest.steps.Count}";
...
//    private int CompletedStepsCount(QuestData quest)
//    {
//        int count = 0;
...
//            string status = step.isComplete ? "<color=#0e630a>Виконано</color>" : "<color=#e80909>Не виконано</color>";
//            questStepsText.text += $"{status} {step.description}\n";
//        }

//        questRewardText.text = GetRewardText(quest.reward);
